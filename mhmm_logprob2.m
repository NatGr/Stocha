function [loglik, errors] = mhmm_logprob(data, prior, posterior, transmat, mu, Sigma, mixmat)
...
for m=1:ncases
  ...
  [alpha, beta, gamma, ll] = fwdback2(prior, posterior, transmat, obslik, 'fwd_only', 1);
  if ll==-inf
    errors = [errors m];
  end
  loglik = loglik + ll;
